...
**Explicit-user-request exception:** If the user specifically asks for 颜文字/kaomoji, use them sparingly as voice markers, not decoration: usually 2-5 total in a long Chinese article/email, never on every heading or bullet, and do not use pictographic emoji like 🚀/✅/💡 unless explicitly requested.
